...
namespace ngraph
{
    std::string prepend_disabled(const std::string&, const std::string&);
}

#define NGRAPH_TEST_(test_case_name, test_name, parent_class, parent_id)                           \
    ...
    ::testing::TestInfo* const GTEST_TEST_CLASS_NAME_(test_case_name, test_name)::test_info_ =     \
        ::testing::internal::MakeAndRegisterTestInfo(                                              \
            #test_case_name,                                                                       \
            ::ngraph::prepend_disabled(#test_case_name, #test_name).c_str(),                       \
            nullptr,                                                                               \
            nullptr,                                                                               \
